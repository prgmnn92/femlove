...
const Button = ({ title, small, isSecondary, onClick, type = "button" }) => {
  return (
    <button
      onClick={onClick}
      type={type}
      className={`relative  duration-300 rounded-[14px] transition-all focus:outline-none focus:ring-2 focus:ring-white/10 focus:ring-offset-2  border-[1px] border-solid border-f-brown cursor-pointer 
