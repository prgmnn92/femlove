  ...
  return showThankYou ? (
    ...
    >
      ...
      <input
        ...
        required
        className="min-w-[230px] flex-auto rounded-md border-2 border-black/5 bg-white/5 px-3.5 py-2 text-black shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-f-red sm:text-sm sm:leading-6"
        placeholder="E-Mail"
      />
